...
export const nftworks = [
  {
    ...
    works: [
      { logo: urlImages + "ZW/A.webp", name: "message.artist.nftworks.zw.works[0].name" },
      { logo: urlImages + "ZW/Akemi_Homura.webp", name: "message.artist.nftworks.zw.works[1].name" },
      { logo: urlImages + "ZW/Card_game.webp", name: "message.artist.nftworks.zw.works[2].name" },
      { logo: urlImages + "ZW/Joker.webp", name: "message.artist.nftworks.zw.works[3].name" },
      { logo: urlImages + "ZW/Kaguya_sama.webp", name: "message.artist.nftworks.zw.works[4].name" },
      { logo: urlImages + "ZW/Kanna.webp", name: "message.artist.nftworks.zw.works[5].name" },
      { logo: urlImages + "ZW/Kuro.webp", name: "message.artist.nftworks.zw.works[6].name" },
      { logo: urlImages + "ZW/Makia.webp", name: "message.artist.nftworks.zw.works[7].name" },
      { logo: urlImages + "ZW/Misa.webp", name: "message.artist.nftworks.zw.works[8].name" },
      { logo: urlImages + "ZW/Noshiro.webp", name: "message.artist.nftworks.zw.works[9].name" },
      { logo: urlImages + "ZW/Satono_Diamond.webp", name: "message.artist.nftworks.zw.works[10].name" },
      { logo: urlImages + "ZW/Tomoyo_Daidoji.webp", name: "message.artist.nftworks.zw.works[11].name" },
    ],
  },
  {
    id: "akiha",
    ...
    works: [
      { logo: urlImages + "Akiha/Armed_girl.webp", name: "message.artist.nftworks.akiha.works[0].name" },
      { logo: urlImages + "Akiha/Crying_in_the_gym.webp", name: "message.artist.nftworks.akiha.works[1].name" },
      { logo: urlImages + "Akiha/Fall.webp", name: "message.artist.nftworks.akiha.works[2].name" },
      { logo: urlImages + "Akiha/Windy.webp", name: "message.artist.nftworks.akiha.works[3].name" },
      { logo: urlImages + "Akiha/After_jogging.webp", name: "message.artist.nftworks.akiha.works[4].name" },
      { logo: urlImages + "Akiha/Summer.webp", name: "message.artist.nftworks.akiha.works[5].name" },
      { logo: urlImages + "Akiha/Shadow.webp", name: "message.artist.nftworks.akiha.works[6].name" },
      { logo: urlImages + "Akiha/X.webp", name: "message.artist.nftworks.akiha.works[7].name" },
      { logo: urlImages + "Akiha/Witch.webp", name: "message.artist.nftworks.akiha.works[8].name" },
      { logo: urlImages + "Akiha/White_hair_angel.webp", name: "message.artist.nftworks.akiha.works[9].name" },
      { logo: urlImages + "Akiha/The_happy_ending_of_a_dying_girl.webp", name: "message.artist.nftworks.akiha.works[10].name" },
      { logo: urlImages + "Akiha/Encountered_and_got_knocked_down.webp", name: "message.artist.nftworks.akiha.works[11].name" },
    ],
  },
  {
    id: "negoro",
    ...
    works: [
      { logo: urlImages + "Negoro/The_duel.webp", name: "message.artist.nftworks.negoro.works[0].name" },
      { logo: urlImages + "Negoro/Irelia.webp", name: "message.artist.nftworks.negoro.works[1].name" },
      { logo: urlImages + "Negoro/Ishtar.webp", name: "message.artist.nftworks.negoro.works[2].name" },
      { logo: urlImages + "Negoro/Luna.webp", name: "message.artist.nftworks.negoro.works[3].name" },
      { logo: urlImages + "Negoro/Lucia.webp", name: "message.artist.nftworks.negoro.works[4].name" },
      { logo: urlImages + "Negoro/Nezuko.webp", name: "message.artist.nftworks.negoro.works[5].name" },
      { logo: urlImages + "Negoro/Yor.webp", name: "message.artist.nftworks.negoro.works[6].name" },
      { logo: urlImages + "Negoro/Princess_knight.webp", name: "message.artist.nftworks.negoro.works[7].name" },
      { logo: urlImages + "Negoro/Rose.webp", name: "message.artist.nftworks.negoro.works[8].name" },
      { logo: urlImages + "Negoro/Kamisato_Ayaka.webp", name: "message.artist.nftworks.negoro.works[9].name" },
      { logo: urlImages + "Negoro/Okita_Sōji.webp", name: "message.artist.nftworks.negoro.works[10].name" },
      { logo: urlImages + "Negoro/Kaedehara_Kazuha.webp", name: "message.artist.nftworks.negoro.works[11].name" },
    ],
  },
  {
    // logo 作品集大图
